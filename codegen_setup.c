...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "No One Can Stop Mr. Domino",
    .project_root_env = "DOMINORECOMP_PROJECT_ROOT",
    .build_dir_env = "DOMINORECOMP_BUILD_DIR",
    .force_setup_env = "DOMINORECOMP_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_008.04_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Domino_Recompiled",
    .prepare_note =
